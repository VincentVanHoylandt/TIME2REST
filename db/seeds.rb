...
user3 = User.create({ first_name: "Philippe", last_name: "Goulliard", age: 49, email: "philippe@lewagon.fr",
                      password: "lewagon", job_title: "Infirmier a domicile" })
...
user21 = User.create({ first_name: "Pierre", last_name: "Lacroix", age: 45, email: "pierre@lewagon.fr",
                       password: "lewagon", job_title: "Décorateur d'événements" })
...
offer1 = Offer.create!({ user_id: user1.id, job_title: "Développeur Web",
                         ...
                         salary: 280, start_time: "2023-03-17", end_time: "2023-04-15" })
offer2 = Offer.create!({ user_id: user2.id, job_title: "Architecte d'intérieur",
                         ...
                         salary: 150, start_time: "2023-03-18", end_time: "2023-04-17" })
offer3 = Offer.create!({ user_id: user3.id, job_title: "Professeur de biologie particulier",
                         ...
                         salary: 200, start_time: "2023-03-25", end_time: "2023-04-23" })
offer4 = Offer.create!({ user_id: user4.id, job_title: "Développeur web",
                         ...
                         salary: 120, start_time: "2023-03-31", end_time: "2023-04-30" })
offer5 = Offer.create!({ user_id: user5.id, job_title: "Psychologue clinicien",
                         ...
                         salary: 300, start_time: "2023-04-01", end_time: "2023-04-29" })
offer6 = Offer.create!({ user_id: user6.id, job_title: "Chef de projet informatique",
                         ...
                         salary: 250, start_time: "2023-04-07", end_time: "2023-05-06" })
offer7 = Offer.create!({ user_id: user7.id, job_title: "Traducteur",
                         ...
                         salary: 100, start_time: "2023-04-14", end_time: "2023-05-13" })
offer8 = Offer.create!({ user_id: user8.id, job_title: "Infirmier a domicile",
                         ...
                         salary: 180, start_time: "2023-04-21", end_time: "2023-05-20" })
offer9 = Offer.create!({ user_id: user9.id, job_title: "Consultant en marketing",
                         ...
                         salary: 220, start_time: "2023-04-28", end_time: "2023-05-27" })
offer10 = Offer.create!({ user_id: user10.id, job_title: "Graphiste",
                          ...
                          salary: 90, start_time: "2023-05-05", end_time: "2023-06-04" })
offer11 = Offer.create!({ user_id: user11.id, job_title: "Mécanicien automobile",
                          ...
                          salary: 150, start_time: "2023-05-12", end_time: "2023-06-11" })
offer12 = Offer.create!({ user_id: user12.id, job_title: "Consultant en ressources humaines",
                          ...
                          salary: 300, start_time: "2023-05-19", end_time: "2023-06-18" })
offer13 = Offer.create!({ user_id: user13.id, job_title: "Photographe",
                          ...
                          salary: 280, start_time: "2023-05-26", end_time: "2023-06-25" })
offer14 = Offer.create!({ user_id: user14.id, job_title: "Chercheur scientifique",
                          ...
                          salary: 350, start_time: "2023-06-02", end_time: "2023-07-01" })
offer15 = Offer.create!({ user_id: user15.id, job_title: "Journaliste",
                          description: "Journaliste indépendant recherche remplaçant pour une durée de 10 jours. Doit posséder de solides compétences en journalisme d'investigation et en écriture d'articles. Le remplaçant sera chargé de couvrir les événements locaux et d'interviewer les personnalités locales.",
                          salary: 200, start_time: "2023-06-09", end_time: "2023-07-08" })
offer16 = Offer.create!({ user_id: user16.id, job_title: "Coach sportif",
                          ...
                          salary: 120, start_time: "2023-06-16", end_time: "2023-07-15" })
offer17 = Offer.create!({ user_id: user17.id, job_title: "Analyste financier",
                          ...
                          salary: 250, start_time: "2023-06-23", end_time: "2023-07-22" })
offer18 = Offer.create!({ user_id: user18.id, job_title: "Monteur vidéo",
                          ...
                          salary: 180, start_time: "2023-06-30", end_time: "2023-07-29" })
offer19 = Offer.create!({ user_id: user19.id, job_title: "Psychiatre",
                          ...
                          salary: 380, start_time: "2023-07-07", end_time: "2023-08-06" })
offer20 = Offer.create!({ user_id: user20.id, job_title: "Analyste de données",
                          ...
                          salary: 200, start_time: "2023-07-14", end_time: "2023-08-13" })
offer21 = Offer.create!({ user_id: user21.id, job_title: "Décorateur d'événements",
                          description: "Je suis un décorateur d'événements professionnel et je suis actuellement à la recherche d'un remplaçant. Le candidat choisi sera responsable de fournir des services de décoration pour les événements de mes clients, tels que des mariages, des anniversaires, etc. Il est important que le candidat ait une expérience en décoration d'événements, qu'il soit créatif et capable de travailler de manière autonome tout en respectant les souhaits des clients. Si vous êtes un décorateur d'événements qualifié et que vous êtes intéressé par ce poste, veuillez me contacter pour discuter des détails du poste.",
                          salary: 150, start_time: "2023-07-21", end_time: "2023-08-20" })
offer22 = Offer.create!({ user_id: user22.id, job_title: "Infirmier a domicile",
                          ...
                          salary: 280, start_time: "2023-07-28", end_time: "2023-08-27" })
offer23 = Offer.create!({ user_id: user23.id, job_title: "Electricien",
                          ...
                          salary: 300, start_time: "2023-08-04", end_time: "2023-09-03" })
offer24 = Offer.create!({ user_id: user24.id, job_title: "Infirmier a domicile",
                          ...
                          salary: 180, start_time: "2023-04-21", end_time: "2023-05-20" })
offer25 = Offer.create!({ user_id: user25.id, job_title: "Infirmier a domicile",
                          ...
                          salary: 180, start_time: "2023-04-21", end_time: "2023-05-20" })
offer26 = Offer.create!({ user_id: user26.id, job_title: "Infirmier a domicile",
                          ...
                          salary: 180, start_time: "2023-04-21", end_time: "2023-05-20" })
offer27 = Offer.create!({ user_id: user27.id, job_title: "Infirmier a domicile",
                          ...
                          salary: 180, start_time: "2023-04-21", end_time: "2023-05-20" })
offer28 = Offer.create!({ user_id: user28.id, job_title: "Infirmier a domicile",
