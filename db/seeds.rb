...
offer1 = Offer.create!({ user_id: user1.id, job_title: "Développeur Web",
                         ...
                         salary: 280, start_time: "2023-03-17", end_time: "2023-04-15", latitude: "49.258329", logitude: "4.031696" })
offer2 = Offer.create!({ user_id: user2.id, job_title: "Architecte d'intérieur",
                         ...
                         salary: 150, start_time: "2023-03-18", end_time: "2023-04-17", latitude: "43.577828", logitude: "7.124934" })
offer3 = Offer.create!({ user_id: user3.id, job_title: "Professeur particulier de biologie",
                         ...
                         salary: 200, start_time: "2023-03-25", end_time: "2023-04-23", latitude: "43.296482", logitude: "5.36978" })
offer4 = Offer.create!({ user_id: user4.id, job_title: "Développeur web",
                         ...
                         salary: 120, start_time: "2023-03-31", end_time: "2023-04-30", latitude: "45.764043", logitude: "4.835659" })
offer5 = Offer.create!({ user_id: user5.id, job_title: "Psychologue clinicien",
                         ...
                         salary: 300, start_time: "2023-04-01", end_time: "2023-04-29", latitude: "43.604652", logitude: "1.444209" })
offer6 = Offer.create!({ user_id: user6.id, job_title: "Chef de projet informatique",
                         ...
                         salary: 250, start_time: "2023-04-07", end_time: "2023-05-06", latitude: "48.117266", logitude: "-1.6777926" })
offer7 = Offer.create!({ user_id: user7.id, job_title: "Traducteur",
                         ...
                         salary: 100, start_time: "2023-04-14", end_time: "2023-05-13", latitude: "48.856614", logitude: "2.3522219" })
offer8 = Offer.create!({ user_id: user8.id, job_title: "Infirmier à domicile",
                         ...
                         salary: 180, start_time: "2023-04-21", end_time: "2023-05-20", latitude: "45.764043", logitude: "4.835659" })
offer9 = Offer.create!({ user_id: user9.id, job_title: "Consultant en marketing",
                         ...
                         salary: 220, start_time: "2023-04-28", end_time: "2023-05-27", latitude: "47.218371", logitude: "-1.553621" })
offer10 = Offer.create!({ user_id: user10.id, job_title: "Graphiste",
                          ...
                          salary: 90, start_time: "2023-05-05", end_time: "2023-06-04", latitude: "49.258329", logitude: "4.031696" })
offer11 = Offer.create!({ user_id: user11.id, job_title: "Mécanicien automobile",
                          ...
                          salary: 150, start_time: "2023-05-12", end_time: "2023-06-11", latitude: "50.631163", logitude: "3.059956" })
offer12 = Offer.create!({ user_id: user12.id, job_title: "Consultant en ressources humaines",
                          ...
                          salary: 300, start_time: "2023-05-19", end_time: "2023-06-18", latitude: "43.296482", logitude: "5.36978" })
offer13 = Offer.create!({ user_id: user13.id, job_title: "Photographe",
                          ...
                          salary: 280, start_time: "2023-05-26", end_time: "2023-06-25", latitude: "45.764043", logitude: "4.835659" })
offer14 = Offer.create!({ user_id: user14.id, job_title: "Chercheur scientifique",
                          ...
                          salary: 350, start_time: "2023-06-02", end_time: "2023-07-01", latitude: "49.442367", logitude: "1.098492" })
offer15 = Offer.create!({ user_id: user15.id, job_title: "Journaliste",
                          ...
                          salary: 200, start_time: "2023-06-09", end_time: "2023-07-08", latitude: "50.62925", logitude: "3.057256" })
offer16 = Offer.create!({ user_id: user16.id, job_title: "Coach sportif",
                          ...
                          salary: 120, start_time: "2023-06-16", end_time: "2023-07-15", latitude: "48.856614", logitude: "2.3522219" })
offer17 = Offer.create!({ user_id: user17.id, job_title: "Analyste financier",
                          ...
                          salary: 250, start_time: "2023-06-23", end_time: "2023-07-22", latitude: "48.390394", logitude: "-4.486076" })
offer18 = Offer.create!({ user_id: user18.id, job_title: "Monteur vidéo",
                          ...
                          salary: 180, start_time: "2023-06-30", end_time: "2023-07-29", latitude: "43.610769", logitude: "3.876716" })
offer19 = Offer.create!({ user_id: user19.id, job_title: "Psychiatre",
                          ...
                          salary: 380, start_time: "2023-07-07", end_time: "2023-08-06", latitude: "47.749926", logitude: "7.335887" })
offer20 = Offer.create!({ user_id: user20.id, job_title: "Analyste de données",
                          ...
                          salary: 200, start_time: "2023-07-14", end_time: "2023-08-13", latitude: "47.903979", logitude: "1.90925" })
offer21 = Offer.create!({ user_id: user21.id, job_title: "Décorateur d'évènements",
                          ...
                          salary: 150, start_time: "2023-07-21", end_time: "2023-08-20", latitude: "47.218371", logitude: "-1.553621" })
offer22 = Offer.create!({ user_id: user22.id, job_title: "Infirmier à domicile",
                          ...
                          salary: 280, start_time: "2023-07-28", end_time: "2023-08-27", latitude: "50.62925", logitude: "3.057256" })
offer23 = Offer.create!({ user_id: user23.id, job_title: "Electricien",
                          ...
                          salary: 300, start_time: "2023-08-04", end_time: "2023-09-03", latitude: "48.117266", logitude: "-1.6777926" })
offer24 = Offer.create!({ user_id: user24.id, job_title: "Infirmier à domicile",
                          ...
                          salary: 180, start_time: "2023-04-21", end_time: "2023-05-20", latitude: "43.610769", logitude: "3.876716" })
offer25 = Offer.create!({ user_id: user25.id, job_title: "Infirmier à domicile",
                          ...
                          salary: 180, start_time: "2023-04-21", end_time: "2023-05-20", latitude: "47.492591", logitude: "0.551442" })
offer26 = Offer.create!({ user_id: user26.id, job_title: "Infirmier à domicile",
                          ...
                          salary: 180, start_time: "2023-04-21", end_time: "2023-05-20", latitude: "47.903979", logitude: "1.90925" })
offer27 = Offer.create!({ user_id: user27.id, job_title: "Infirmier à domicile",
                          ...
                          salary: 180, start_time: "2023-04-21", end_time: "2023-05-20", latitude: "48.390394", logitude: "-4.486076" })
