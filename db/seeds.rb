...
user1 = User.create({ first_name: "Vincent", last_name: "Vanhoylandt", age: 27, email: "vincent@lewagon.fr",
                      password: "lewagon", job_title: "Développeur Web", photo_url: "https://avatars.githubusercontent.com/u/122786724?v=4" })
...
user2 = User.create({ first_name: "Christian", last_name: "Bondzie", age: 44, email: "christian@lewagon.fr",
                      password: "lewagon", job_title: "Architecte d'intérieur", photo_url: "https://avatars.githubusercontent.com/u/73429254?v=4" })
...
user3 = User.create({ first_name: "Philippe", last_name: "Goulliard", age: 49, email: "philippe@lewagon.fr",
                      password: "lewagon", job_title: "Infirmier à domicile", photo_url: "https://avatars.githubusercontent.com/u/122784805?v=4" })
...
user4 = User.create({ first_name: "Jeremy", last_name: "Twardowski", age: 36, email: "jeremy@lewagon.fr",
                      password: "lewagon", job_title: "Electricien", photo_url: "https://avatars.githubusercontent.com/u/62162162?v=4" })
